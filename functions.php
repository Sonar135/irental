<?php
    ...
    function create_user($conn, $email, $fname, $lname, $phone, $password){

 
  
        $insert= "INSERT INTO users (Fname, Lname, phone,  email,  password) VALUES (?,?,?,?,?)";   
        ...
        mysqli_stmt_bind_param($stmt2, 'sssss', $fname, $lname, $phone,  $email, $hashed_pwd);
    ...
    function emptysignup($email, $fname, $lname,  $phone, $password, $confirm ){
        $result="";
        if($email=="" or $fname=="" or $lname==""  or $phone=="" or $password=="" or $confirm=="" ){
            $result= true;
        }
        else {
            $result=false;
